...
def main():
    ...
    if config["USE_DQN"]:
      ...
      DQN_agent.train_run(num_eps, agent=agent, file=path + "dqn_best_agent.pth", start_episode=0)
    else:
      #Run the code of abachurin
      ...
      Q_agent.train_run(num_eps, agent=agent, file=path + "new_best_agent.npy", start_ep=0)
